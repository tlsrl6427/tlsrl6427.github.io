...
## 접근방식
![images1](/assets/img/2024-06-26-add-two-numbers/images1.jpg){: w="700" h="700" }
- 제출용 변수와 실제로 움직일 변수를 선언한다
- 새 노드를 생성한 후 더한 값을 넣고, 자릿수가 넘어가는 값은 따로 저장한다
</br>

![images2](/assets/img/2024-06-26-add-two-numbers/images2.jpg){: w="700" h="700" }
- 새 노드를 생성하고, 전 노드의 next에 넣은 후 더한 값을 넣는다
- 자릿수가 넘어갔으니 따로 저장한다
</br>

![images3](/assets/img/2024-06-26-add-two-numbers/images3.jpg){: w="700" h="700" }
- 넘어간 자릿수를 추가로 더한다
</br>
...
3. 두 리스트의 길이가 다르기 때문에 끊긴 쪽은 null값을 처리한다
